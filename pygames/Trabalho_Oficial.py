...
volta_ao_menu = pygame.font.Font('SuperMario256.ttf', 30)
nome_jogo = pygame.font.Font('SuperMario256.ttf', 150)
instrucoes = pygame.font.Font('SuperMario256.ttf', 22)
font = pygame.font.Font('SuperMario256.ttf', 40)
level_surface = font.render("LEVEL 01", False, AMARELO)
game_over_surface = font.render("GAME OVER", False, VERMELHO)
recomecar = font.render("Pressione P para recomecar", False , AMARELO)
voltar_menu = volta_ao_menu.render("Pressione ESC para voltar ao menu", False , AMARELO)
...
class Laser(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.rect.y > self.tela_altura + 15 or self.rect.y < 0: #se sair da tela o tiro desaparece
            self.kill()
...
while True:
    ...
    if cena =="jogo":
        ...
        if jogo.run:
            tela.blit(level_surface, (540,750,50,5))
        else:
            tela.blit(recomecar, (35,500,50,5))
            tela.blit(game_over_surface, (450,750,50,5))
            tela.blit(voltar_menu, (40,570,50,5) )
        ...
        for live in range(jogo.vidas):
            ...
            x += 50
        tela.blit(score_text_surface,(50,10,50,50))
        score_surface = font.render(str(jogo.score),False,AMARELO)
        tela.blit(score_surface, (50,50,50,50))
        ...
        tela.fill(CINZA)
        text = nome_jogo.render("JOGO", True, AMARELO)
        ...
        tela.blit(text, (175, 150))
        tela.blit(text_comandos, (12,500))
